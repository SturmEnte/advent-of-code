...
### C
Build and run command for C (while being in the folder of the year and day) with gcc:
``gcc part?.c ../../common/file_utils.c -o ../../solution.out && ../../solution.out input.txt``

## Progess

| Day / Year | 2015 | 2016 | 2021 | 2022 | 2023 | 2024 | 2025 |
| ---------- | ---- | ---- | ---- | ---- | ---- | ---- | ---- |
| 1          | \*\* | \*\* | \*\* | \*\* | \*\* | \*\* | \*\* |
| 2          | \*\* | \*\* | \*\* | \*\* | \*\* | \*   | \*\* |
| 3          | \*\* | \*\* | \*   | \*\* | \*   |      | \*\* |
